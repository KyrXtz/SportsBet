...
class SportsTickerEventRequestMapping : Profile
{
    public SportsTickerEventRequestMapping()
    {
        #region XML
        CreateMap<SportsTickerEventListXmlRequest, SportsTickersEventsPayload>()
        ...
        CreateMap<SportsTickerEventListItemXml, SportsTickerEventListItem>()
        ...
        CreateMap<SportsTickerEventLineupXml, SportsTickerEventLineupItem>();
        CreateMap<SportsTickerEventLineupPlayerXml, SportsTickerEventLineupPlayerItem>();
        #endregion

        #region JSON
        CreateMap<SportsTickerEventListJsonRequest, SportsTickersEventsPayload>();
        CreateMap<SportsTickerEventListJson, SportsTickersEventList>();
        CreateMap<SportsTickerEventListItemJson, SportsTickerEventListItem>()
            .ForMember(destination => destination.ScoreDict,
        ...
        CreateMap<SportsTickerEventLineupJson, SportsTickerEventLineupItem>();
        CreateMap<SportsTickerEventLineupPlayerJson, SportsTickerEventLineupPlayerItem>();
        #endregion
    }
}
